...
exports.SurveyQuestionResponseModel =
  exports.SurveyQuestionResponseCollection =
    void 0;
  ...
  constructor(collection) {
    ...
    Object.defineProperty(this, "findByQuestionId", {
      ...
      value: async (questionId) => {
        ...
        const docs = await this.collection.find({ [key]: questionId })
          .toArray();
        return docs.map(this.toDocument);
      },
    });
...
Object.defineProperty(SurveyQuestionResponseModel, "create", {
  ...
  writable: true,
  value: (db) =>
    new SurveyQuestionResponseModel(
      (0, exports.SurveyQuestionResponseCollection)(db),
    ),
});
