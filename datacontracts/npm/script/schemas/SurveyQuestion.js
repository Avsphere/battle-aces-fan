    ...
    Object.defineProperty(this, "isSameAs", {
      ...
      value: (other) => {
        ...
        if (other.kind === "basic") {
          ...
          const areUnitsTheSame =
            other.details.relevantUnitSlugs?.sort().join() ===
              this.details.relevantUnitSlugs?.sort().join();
          const areOpposingUnitsTheSame =
            other.details.oppositeUnitSlugs?.sort().join() ===
              this.details.oppositeUnitSlugs?.sort().join();
...
Object.defineProperty(SurveyQuestion, "isSameAsDetails", {
  ...
  value: (question1, question2) => {
    ...
    if (question1.kind === "basic") {
      ...
      const areUnitsTheSame = question2.relevantUnitSlugs?.sort().join() ===
        question1.relevantUnitSlugs?.sort().join();
      const areOpposingUnitsTheSame =
        question2.oppositeUnitSlugs?.sort().join() ===
          question1.oppositeUnitSlugs?.sort().join();
      return isTextTheSame && areUnitsTheSame && areOpposingUnitsTheSame;
    }
    return false;
  },
