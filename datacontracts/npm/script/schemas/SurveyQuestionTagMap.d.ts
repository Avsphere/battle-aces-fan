...
export declare const SurveyQuestionTagMap: z.ZodRecord<
  z.ZodEnum<["basic", "unit_single", "unit_matchup_1v1"]>,
  z.ZodRecord<
    z.ZodEnum<["veryUnhappy", "unhappy", "neutral", "happy", "veryHappy"]>,
  ...
  z.ZodTypeAny,
  {
    ...
    data: Partial<
      Record<
        ...
        Partial<
          Record<
            "veryUnhappy" | "unhappy" | "neutral" | "happy" | "veryHappy",
            string[]
          >
        >
      >
...
>;
export type SurveyQuestionTagMapSchema = z.infer<
  typeof SurveyQuestionTagMapSchema
>;
