...
export const DenoBuildTooler = async () => {
    ...
    const publishAll = async () => {
        ...
        for (const module of modules.buildTools) {
            ...
            console.log(chalk.blueBright(`Published ${module.buildOptionsUpdater.getPackageName()} version ${module.buildOptionsUpdater.getCurrentVersion()} now waiting for it to become available`))
