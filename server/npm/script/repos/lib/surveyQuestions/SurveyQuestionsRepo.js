...
const SurveyQuestionResponseRepo_js_1 = require(
  "./lib/SurveyQuestionResponseRepo.js",
);
const SurveyQuestionTagMapRepo_js_1 = require(
  "./lib/SurveyQuestionTagMapRepo.js",
);
...
class SurveyQuestionsRepo {
  constructor(repos) {
    ...
    this.responses =
      (0, SurveyQuestionResponseRepo_js_1.SurveyQuestionResponseRepo)(repos);
    this.tagMap = (0, SurveyQuestionTagMapRepo_js_1.SurveyQuestionTagMapRepo)(
      repos,
    );
  }
}
