...
exports.SurveyQuestionTagMap = zod_1.z.record(
  SurveyQuestion_js_1.SurveyQuestionKind,
  zod_1.z.record(
    SmileyFaceRating_js_1.SmileyFaceRating,
    zod_1.z.array(SurveyQuestionTag_js_1.SurveyQuestionTag),
  ),
);
/**
