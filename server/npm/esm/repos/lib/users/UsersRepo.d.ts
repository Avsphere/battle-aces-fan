...
export declare class UsersRepo {
  ...
  findById: (
    params: Parameters<UserModel["findById"]>[0],
  ) => Promise<import("@battle-aces-fan/datacontracts").User>;
  findByUsername: (
    params: Parameters<UserModel["findByBattleAcesUsername"]>[0],
  ) => Promise<
    (username: string) => Promise<import("@battle-aces-fan/datacontracts").User>
  >;
