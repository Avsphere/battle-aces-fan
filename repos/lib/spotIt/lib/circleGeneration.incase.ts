...
//   x: number;
//   y: number;
//   // width and height represent bounding box dimension for overlap
//   width: number;
//   height: number;
//   // fullWidth and fullHeight represent the actual scaled dimension of the image
//   fullWidth: number;
//   fullHeight: number;
//   angle?: number;
// }
...
//         // Scale image so that the smaller dimension equals chosenSize
...
//         // For overlap bounding box, we still use chosenSize (the smaller dimension) as w/h
...
//         // Check if fully inside the circle using actual dimensions
//         if (
//           circleGeneration.insideCircle(x, y, finalWidth, finalHeight, circleCenter, radius, 0) &&
//           // Check overlap using boundingBoxSize (do not change how overlap works)
...
//     // No changes here: w, h, p.width, p.height are the bounding box dimensions
...
//           // Use the actual fullWidth/fullHeight for rendering
