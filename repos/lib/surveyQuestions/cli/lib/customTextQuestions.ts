...
export const CUSTOM_TEXT_QUESTIONS : SurveyQuestionDetails[] = [
    ...
    },
    {
        ...
        tags : ['most of the time', 'rarely', 'meh', 'hurts my soul', 'fun', 'frustrating']
    },
    {
        kind : 'basic',
        subKind : 'text',
        text : 'Do you enjoy the way target firing works?',
        tags : ['most of the time', 'rarely', 'meh', 'feels inconsistent', 'creates a fun dynamic', 'frustrating']
    },
    {
        kind : 'basic',
        subKind : 'text',
        text : 'Do you feel that units are consistent in their behavior?',
        tags : ['most of the time', 'rarely', 'not in collision situations', 'meh', 'frustrating']
    },
    {
        kind : 'basic',
        subKind : 'text',
    ...
    },
    {
        ...
        tags : ['most of the time', 'rarely', 'they make positioning more interesting', 'they hurt my soul',]
    },
] 