import { z } from "zod";
export declare const SurveyQuestionKind: z.ZodEnum<["basic", "unit_single", "unit_matchup_1v1"]>;
...
export declare const SurveyQuestion_UnitMatchupSchema: z.ZodObject<{
    ...
    firstUnitSlug: z.ZodEnum<["bulwark", "ballista", "crab", "butterfly", "katbus", "kingcrab", "hunter", "heavyballista", "dragonfly", "recall", "bomber", "recallhunter", "kraken", "locust", "crusader", "falcon", "scorpion", "valkyrie", "airship", "beetle", "sniper", "recallshocker", "shocker", "gargantua", "predator", "advancedblink", "advancedrecall", "advanceddestroyer", "blinkhunter", "assaultbot", "artillery", "swiftshocker", "mammoth", "gunbot", "mortar", "blink", "advancedbot", "stinger", "behemoth", "missilebot", "heavyhunter", "destroyer", "hornet", "turret", "crossbow", "knight", "raider", "wasp", "flakturret"]>;
    secondUnitSlug: z.ZodEnum<["bulwark", "ballista", "crab", "butterfly", "katbus", "kingcrab", "hunter", "heavyballista", "dragonfly", "recall", "bomber", "recallhunter", "kraken", "locust", "crusader", "falcon", "scorpion", "valkyrie", "airship", "beetle", "sniper", "recallshocker", "shocker", "gargantua", "predator", "advancedblink", "advancedrecall", "advanceddestroyer", "blinkhunter", "assaultbot", "artillery", "swiftshocker", "mammoth", "gunbot", "mortar", "blink", "advancedbot", "stinger", "behemoth", "missilebot", "heavyhunter", "destroyer", "hornet", "turret", "crossbow", "knight", "raider", "wasp", "flakturret"]>;
    tags: z.ZodArray<z.ZodString, "many">;
}, "strip", z.ZodTypeAny, {
...
export declare const SurveyQuestion_BasicSchema: z.ZodObject<{
    ...
    subKind: z.ZodString;
    text: z.ZodString;
    relevantUnitSlugs: z.ZodOptional<z.ZodArray<z.ZodEnum<["bulwark", "ballista", "crab", "butterfly", "katbus", "kingcrab", "hunter", "heavyballista", "dragonfly", "recall", "bomber", "recallhunter", "kraken", "locust", "crusader", "falcon", "scorpion", "valkyrie", "airship", "beetle", "sniper", "recallshocker", "shocker", "gargantua", "predator", "advancedblink", "advancedrecall", "advanceddestroyer", "blinkhunter", "assaultbot", "artillery", "swiftshocker", "mammoth", "gunbot", "mortar", "blink", "advancedbot", "stinger", "behemoth", "missilebot", "heavyhunter", "destroyer", "hornet", "turret", "crossbow", "knight", "raider", "wasp", "flakturret"]>, "many">>;
    oppositeUnitSlugs: z.ZodOptional<z.ZodArray<z.ZodEnum<["bulwark", "ballista", "crab", "butterfly", "katbus", "kingcrab", "hunter", "heavyballista", "dragonfly", "recall", "bomber", "recallhunter", "kraken", "locust", "crusader", "falcon", "scorpion", "valkyrie", "airship", "beetle", "sniper", "recallshocker", "shocker", "gargantua", "predator", "advancedblink", "advancedrecall", "advanceddestroyer", "blinkhunter", "assaultbot", "artillery", "swiftshocker", "mammoth", "gunbot", "mortar", "blink", "advancedbot", "stinger", "behemoth", "missilebot", "heavyhunter", "destroyer", "hornet", "turret", "crossbow", "knight", "raider", "wasp", "flakturret"]>, "many">>;
    tags: z.ZodArray<z.ZodString, "many">;
}, "strip", z.ZodTypeAny, {
    kind: "basic";
    tags: string[];
...
export type SurveyQuestion_BasicSchema = z.infer<typeof SurveyQuestion_BasicSchema>;
export declare const SurveyQuestionDetails: z.ZodDiscriminatedUnion<"kind", [z.ZodObject<{
    kind: z.ZodLiteral<"unit_single">;
    unitSlug: z.ZodString;
    tags: z.ZodArray<z.ZodString, "many">;
}, "strip", z.ZodTypeAny, {
...
export declare const SurveyQuestionSchema: z.ZodObject<{
    ...
    details: z.ZodDiscriminatedUnion<"kind", [z.ZodObject<{
        kind: z.ZodLiteral<"unit_single">;
        unitSlug: z.ZodString;
        tags: z.ZodArray<z.ZodString, "many">;
    }, "strip", z.ZodTypeAny, {
...
export declare class SurveyQuestion<T extends SurveyQuestionDetails = SurveyQuestionDetails> {
    ...
    static isSameAsDetails: (question1: SurveyQuestionDetails, question2: SurveyQuestionDetails) => boolean;
    get kind(): T["kind"];
    get details(): T;
}
