...
const SurveyQuestionResponseModel_js_1 = require(
  "./lib/SurveyQuestionResponseModel.js",
);
const SurveyQuestionTagMapModel_js_1 = require(
  "./lib/SurveyQuestionTagMapModel.js",
);
...
const Models = (client) => {
  ...
  const surveyQuestions = SurveyQuestionModel_js_1.SurveyQuestionModel.create(
    db,
  );
  const surveyQuestionResponses = SurveyQuestionResponseModel_js_1
    .SurveyQuestionResponseModel.create(db);
  const surveyQuestionTagMap = SurveyQuestionTagMapModel_js_1
    .SurveyQuestionTagMapModel.create(db);
